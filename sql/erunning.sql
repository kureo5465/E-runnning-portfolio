...
insert into categories (id, title) values (1, 'プログラミング');
insert into categories (id, title) values (2, 'デザイン');
insert into categories (id, title) values (3, 'マーケティング');
...
insert into accounts (name, hashed_password) 
 values ('user01', '$2y$10$LNuN3PaMsK7jW..52DRi6eNhCaUmIJCLug2SilxPsTZmrB3gFt1Va');
